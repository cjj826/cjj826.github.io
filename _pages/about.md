...
Publications
======
* **Auto-PRE: An Automatic and Cost-Efficient Peer-Review Framework for Language Generation Evaluation**<br>
  **Junjie Chen**, Weihang Su, Zhumin Chu, Haitao Li, Yujia Zhou, Dingbo Yuan, Xudong Wang, JUN ZHOU, Yiqun LIU, Min Zhang, Shaoping Ma, Qingyao Ai<br>
  **(AAAI 2026 Main, Long Paper, CCF-A)**<br>
...
* **Simulating Dispute Mediation with LLM-Based Agents for Legal Research**<br>
  **Junjie Chen**, Haitao Li, Minghao Qin, Yujia Zhou, Yanxue Ren, Wuyue Wang, Yiqun Liu, Yueyue Wu, Qingyao Ai<br>
  **(AAAI 2026 Main, Long Paper, CCF-A)**<br>
  [[Paper]](https://arxiv.org/pdf/2509.06586)[[Code]](https://github.com/cjj826/AgentMediation)
  
* **Enhancing LLM-Based Agents via Global Planning and Hierarchical Execution**<br>
  **Junjie Chen**, Haitao Li, Jingli Yang, Yiqun Liu, Qingyao Ai<br>
  **(NCIIP 2025, Best Paper)**<br>
  [[Paper]](https://arxiv.org/pdf/2504.16563)[[Code]](https://github.com/cjj826/GoalAct)

* **Overview of the NTCIR-18 Automatic Evaluation of LLMs (AEOLLM) Task**<br>
  **Junjie Chen**, Haitao Li, Zhumin Chu, Yiqun Liu, Qingyao Ai<br>
  **(NTCIR-18)**<br>
  [[Paper]](https://arxiv.org/pdf/2503.13038)[[Code]](https://huggingface.co/spaces/THUIR/AEOLLM)

* **LegalAgentBench: Evaluating LLM Agents in Legal Domain** <br>
  Haitao Li\*, **Junjie Chen\***, Jingli Yang, Qingyao Ai, Wei Jia, Youfeng Liu, Kai Lin, Yueyue Wu, Guozhi Yuan, Yiran Hu, Wuyue Wang, Yiqun Liu, Minlie Huang (\* Equal contribution)<br>
...
* **Llms-as-judges: a comprehensive survey on llm-based evaluation methods**<br>
  Haitao Li, Qian Dong, **Junjie Chen**, Huixue Su, Yujia Zhou, Qingyao Ai, Ziyi Ye, Yiqun Liu<br>
...
* **LexRAG: Benchmarking Retrieval-Augmented Generation in Multi-Turn Legal Consultation Conversation**<br>
  ...
  **(SIGIR 2025, Long Paper, CCF-A)**<br>
